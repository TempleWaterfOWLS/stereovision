...
main( int argc, char** argv )
{
    ...
    switch ( argc )
    {
        ...
        case 3:
            ...
            if ( argc == 3 )
            {
            	printf( "Using default min max output values: %u %u\n", ucMinOut, ucMaxOut );
            }
        ...
        default:
            ...
            printf( "Usage: %s <input pgm> <output pgm> [<min out> <max out>]\n", argv[0] );
            printf( "Using default arguments: scaleimage 'disparity.pgm' 'disparity-scaled.pgm' 90 255\n\n" );
            break;
    }
